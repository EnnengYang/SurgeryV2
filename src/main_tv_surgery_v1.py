...
args.rank = 304 # 304: ViT-B-32, ViT-B-16; 132: ViT-L-14
...
for iteration in range(iterations):
    ...
    for dataset_name in learn_datasets:
        ...
        for i, data in enumerate(tqdm.tqdm(dataloader)):
            ...
            outputs, surgery_features, merged_features, bias_features = alpha_model(x, dataset_name)
            finetuned_features = finetuned(x).detach()

            loss = loss_func(surgery_features, finetuned_features)
